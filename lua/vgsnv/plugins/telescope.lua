return {
    ...
    config = function()
        ...
        telescope.setup({
            ...
            pickers = {
                colorscheme = {enable_preview = true, initial_mode = "normal"},
                lsp_implementations = {
                    initial_mode = "normal",
                    preview = false,
                    show_line = false,
                ...
                oldfiles = {
                    ...
                    path_display = {"tail"},
                    previewer = false,
                    layout_config = {width = 40, height = 12}
                }
            }
        })
        ...
        keymap.set("n", "sf", function()
            telescope.extensions.file_browser.file_browser({
                ...
                previewer = false,
                initial_mode = "normal",
                layout_config = {horizontal = {width = 80, height = 26}}
            })
        end)
        ...
        keymap.set("n", "sg", "<cmd>Telescope live_grep<cr>",
                   {desc = "Find string in cwd"})
        keymap.set("n", "sc", "<cmd>Telescope grep_string<cr>",
